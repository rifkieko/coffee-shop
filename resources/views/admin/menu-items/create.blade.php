    ...
    <div class="py-12">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm rounded-lg">
                <div class="p-6">
                    <form method="POST" action="{{ route('admin.menu-items.store') }}" class="space-y-6" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <x-text-input id="low_stock_threshold" name="low_stock_threshold" type="number" min="0"
                                              class="mt-1 block w-full" :value="old('low_stock_threshold', 5)" />
                                <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
                                    {{ __('Notifikasi akan dikirim saat stok turun pada atau di bawah angka ini.') }}
                                </p>
