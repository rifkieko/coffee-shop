    ...
    <div class="bg-[#f7f8fc] dark:bg-[#0f1117]">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 space-y-8">
            ...
            <div class="overflow-x-auto -mx-2 px-2 pb-1">
                <div class="inline-flex min-w-max flex-nowrap gap-3 rounded-[999px] bg-white/60 px-4 py-3 shadow-sm dark:bg-gray-900/40">
                    ...
                    <a href="{{ route('admin.reports.sales') }}" class="whitespace-nowrap inline-flex items-center gap-2 rounded-full border border-indigo-200 bg-indigo-50 px-4 py-2 sm:py-2.5 text-sm font-semibold text-indigo-700 shadow-sm hover:bg-indigo-100">
                        {{ __('Rekap Penjualan') }}
                    </a>
                </div>
            </div>
